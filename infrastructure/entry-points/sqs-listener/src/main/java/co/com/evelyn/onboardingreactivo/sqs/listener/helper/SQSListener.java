package co.com.evelyn.onboardingreactivo.sqs.listener.helper;

import co.com.evelyn.onboardingreactivo.sqs.listener.config.SQSProperties;
...
public class SQSListener {
    ...
    public SQSListener start() {
        ...
        int threads = properties.numberOfThreads() != null && properties.numberOfThreads() > 0
